...
namespace FenixAlliance.ABP.SDK.CSharp.Clients.StorageService
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task RadzenUploadStreamScopedAsync(string tenantId, string recordType, string recordId, string api_version, string x_api_version)
        {
            return RadzenUploadStreamScopedAsync(tenantId, recordType, recordId, api_version, x_api_version, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RadzenUploadStreamScopedAsync(string tenantId, string recordType, string recordId, string api_version, string x_api_version, System.Threading.CancellationToken cancellationToken)
        {
            if (tenantId == null)
                throw new System.ArgumentNullException("tenantId");
